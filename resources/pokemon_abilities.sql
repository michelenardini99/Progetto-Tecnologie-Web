...
CREATE TABLE `abilities` (
  ...
  KEY `ix_abilities_is_main_series` (`is_main_series`),
  CONSTRAINT `abilities_ibfk_1` FOREIGN KEY (`generation_id`) REFERENCES `generations` (`id`),
  CONSTRAINT `abilities_chk_1` CHECK ((`is_main_series` in (0,1)))
) ENGINE=InnoDB AUTO_INCREMENT=10061 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
